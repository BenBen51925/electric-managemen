package com.henghao.comSerialPort.portManager;
...
public class SerialPortManager {
    ...
    public static final ArrayList<String> findPort() {
        // 获得当前所有可用串口
        System.out.println("<-------正在获得当前所有可用串口.....------>");
    ...
    public static void closePort(SerialPort serialPort) {
        if (serialPort != null) {
            System.err.println("<----正在关闭串口...---->");
            serialPort.close();
            serialPort = null;
            System.err.println("<----成功关闭串口---->");
        }
    }
    ...
    public static void addListener(SerialPort port,
        ...
        try {
            //listener.serialEvent(SerialPortEvent.CTS);
